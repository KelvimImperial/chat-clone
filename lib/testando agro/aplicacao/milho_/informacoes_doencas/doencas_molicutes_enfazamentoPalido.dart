...
class EnfazamentoPalidoPage extends StatefulWidget {
  const EnfazamentoPalidoPage({Key? key}) : super(key: key);

  @override
  EnfazamentoPalidoPageState createState() {
    return EnfazamentoPalidoPageState();
  }
}

class EnfazamentoPalidoPageState extends State<EnfazamentoPalidoPage> {
  String x = """ """;
  @override
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: const Text("Enfazamento Pálido(Spiroplasma)",
                                    style: TextStyle(
                                        fontSize: 30,
