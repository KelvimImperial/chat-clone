...
class DiplodiaMaydisPage extends StatefulWidget {
  const DiplodiaMaydisPage({Key? key}) : super(key: key);

  @override
  DiplodiaMaydisPageState createState() {
    return DiplodiaMaydisPageState();
  }
}

class DiplodiaMaydisPageState extends State<DiplodiaMaydisPage> {
  String x = """ """;
  @override
